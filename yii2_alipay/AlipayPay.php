...
namespace app\yii2_alipay;

use app\yii2_alipay\AlipaySubmit;
...
class AlipayPay {
     ...
     */
    public $partner = '2088112142982934';

    /**
     * @var String 收款支付宝账号
     */
    public $seller_email = 'uoi00';

    /**
     * @var String 安全检验码，以数字和字母组成的32位字符
     */
    public $key = 'wy0a3y1nhiajvv87g51lkxet1ugx0lpa';
    ...
    public $notify_url = 'https://openapi.alipay.com/gateway.do';
    ...
    public $return_url = 'https://openapi.alipay.com/gateway.do';
